...
# # using the server to turn a light on and off
...
# # using the server to see if a switch is pushed or not
...
# using the server to see the brightness level of the room
adc = machine.ADC(0)
